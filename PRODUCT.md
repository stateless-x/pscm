...
Petkasem Ceramic Machine Co., Ltd. is a Thai manufacturer of ceramic-production machinery founded in 1986. The company designs, builds, installs, repairs, and supplies parts for its own machines from its Nakhon Pathom workshop. The website is a bilingual, Thai-first marketing and lead-generation site; it has no account or transactional workflow.
...
The differentiator is continuity of responsibility: the team that designs and builds a machine is also the team that services it and makes its parts. The site should make this feel like lower operational risk, not generic “quality service.” Product discovery can begin from either a machine catalogue or a real factory problem.

## Durable proof and constraints
...
- Feel like a capable, established workshop—not a generic SaaS template or a luxury catalogue.
- Lead with useful specificity, visible machinery, and direct routes from problem to conversation.
- Thai typography must remain highly legible; English is a complete alternate locale, never stacked as decoration.
- Mobile contact actions stay thumb-reachable. Motion is optional, lightweight, and respects reduced-motion preferences.

## Redesign mandate

The user explicitly authorized a full replacement visual world and delegated palette, typography, icon, layout, and interaction choices. Product truth and working behavior stay fixed; the incumbent graphite/amber interface is an anti-reference rather than visual authority.
